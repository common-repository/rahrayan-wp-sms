...
<html lang="en">
	<head>
		...
		<style>
			...
			<?php $color=(get_option('rahrayan_ibg') != 'none')? get_option('rahrayan_ibg') : ''; ?>
			.rahrayan_name{
			...
			<?php $color=(get_option('rahrayan_ihbg') != 'none')? get_option('rahrayan_ihbg') : ''; ?>
			.rahrayan_name:focus {
	...
	<body>
      ...
      <section class="mpsidebar">
        <div class="mpnew">
        	<input maxlength="255" type="text" class="textbox_rahrayan rahrayan_fname rahrayan_name" placeholder="نام">
			<input maxlength="255" type="text" class="textbox_rahrayan rahrayan_name rahrayan_lname" placeholder="نام خانوادگی">
			<input type="text" class="textbox_rahrayan rahrayan_mobile" placeholder="موبایل">
			<select class="textbox_rahrayan rahrayan_gender">
				<option disabled selected value="">جنسیت</option>
				<option value="1">زن</option>
				<option value="2">مرد</option>
			</select>
			<select class="textbox_rahrayan rahrayan_group">
				<option disabled selected value="">گروه کاربری</option>
				<?php echo $rahrayan -> fetch_phonebook_groups(true,'',false,true) ?>
			</select>
			<input type="submit" id="submit_rahrayan" class="submit_rahrayan" value="اشتراک یا لغو اشتراک">
        </div>
			<div style="display:none" class="mpcode">
				<div id="mpcode"></div>
					<input type="text" class="textbox_rahrayan rahrayan_code" placeholder="کد تایید">
				<input type="submit" id="submitcmp" class="submit_rahrayan" value="ارسال کد تایید">
			</div>
		</section>
		</form>
	</body>
